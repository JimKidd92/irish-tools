...
export const COUNTY_ABOUT = {
  ...
  Westmeath:
    'A lakeland county at the very centre of Ireland, Westmeath is dotted with the waters of Lough Ree, Lough Owel and Lough Ennell. Athlone, straddling the Shannon, is its lively hub and home to one of the oldest pubs in the world. It’s a place of fishing, boating and unhurried midland calm.',
  Wexford:
    'The sunny south-east corner, Wexford enjoys some of Ireland’s best weather and finest beaches. It has deep Viking and Norman roots, a proud place in the 1798 Rebellion, and a celebrated opera festival. With its strawberry fields, working lighthouses and long sandy strands, it’s a favourite for Irish summer holidays.',
  Wicklow:
    'Known as the “Garden of Ireland”, Wicklow rises just south of Dublin into a glorious upland of mountains, glens and lakes. Its jewels are the monastic valley of Glendalough and the great gardens of Powerscourt and Mount Usher. Wild, accessible and endlessly scenic, it’s the capital’s green escape.',
  Clare:
    'Clare is a county of stone and music. Along its Atlantic edge stand the towering Cliffs of Moher and the strange lunar limestone of the Burren, where Arctic and Mediterranean flowers grow side by side. Inland, it’s the spiritual home of Irish traditional music, with sessions in pubs from Doolin to Ennistymon.',
  Cork:
  ...
  Leitrim:
    'Ireland’s least-populated county, Leitrim is a hidden landscape of small lakes, drumlin hills and the meandering Shannon–Erne Waterway. Long overlooked, it has become a quiet haven for artists and those seeking a slower life. Tiny Carrick-on-Shannon, its capital, is a hub for boating the great river system.',
  Mayo:
    'Big, wild and beautiful, Mayo runs along the Atlantic in the north-west. Its landmarks are the holy mountain of Croagh Patrick, climbed by pilgrims for 1,500 years, dramatic Achill Island, and the Marian shrine at Knock. A county of bog, mountain and empty beaches, it carries the memory of the Famine in its very landscape.',
  Roscommon:
  ...
  Derry:
    'Derry is built around Ireland’s only completely walled city, whose 17th-century walls still encircle the old town above the River Foyle. The county runs from the historic city out to the wild Sperrin Mountains and a dramatic north coast at Mussenden Temple and Downhill. A place of deep history, resilience and a famously warm welcome.',
  Donegal:
    'Remote, rugged and wildly beautiful, Donegal occupies the far north-west, all but cut off from the rest of the Republic by the border. It boasts the towering sea cliffs of Slieve League, the wilderness of Glenveagh, surf-battered beaches and one of the strongest Gaeltacht regions in the country. The “forgotten county”, and gloriously so.',
  Down:
    'Down rolls down to the sea in the south-east of Ulster, crowned by the granite peaks of the Mountains of Mourne that “sweep down to the sea”. St Patrick is said to be buried at Downpatrick, and the county’s gentle drumlins, Strangford Lough and pretty harbour villages make it one of the loveliest corners of the north.',
  Fermanagh:
    'Fermanagh is lakeland Ulster, a county built around the island-studded waters of Upper and Lower Lough Erne. Boating, fishing and island-hopping to ancient monastic sites like Devenish define it, while the historic town of Enniskillen sits on an island between the two lakes. Watery, green and serenely beautiful.',
  Monaghan:
    'A small border county of little drumlin hills and quiet lakes, Monaghan is the “Farney County” and the home place of the poet Patrick Kavanagh, who turned its stony grey soil into great literature. It’s a landscape of small farms, market towns and an understated, hard-won charm.',
  Tyrone:
    'Tyrone, the largest county in Northern Ireland, stretches from the shores of Lough Neagh up into the lonely Sperrin Mountains. It’s a county of strong farming and GAA tradition, and home to the Ulster American Folk Park, which tells the story of the millions who emigrated from Ulster to the New World.',
}
